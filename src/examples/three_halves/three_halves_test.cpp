...
#ifndef ABY_THREE_HALVES_H
#define ABY_THREE_HALVES_H
...
int main(int argc, char** argv) {
    ...
    e_role role;
    uint32_t operationbitlen = 8, secparam = 128, nthreads = 1;
    uint16_t port = 7766;
    ...
    test_three_halves_circuit(role, address, port,
